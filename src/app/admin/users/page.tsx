...
function Users() {
  ...
  const filteredData = users.filter((u) => {
    ...
    return (
        ...
        (u.createdAt ? new Date(u.createdAt).toLocaleDateString() : "").toLowerCase().includes(searchLower)
    ...
    <>
        ...
        <div className=" overflow-x-auto">
            ...
            <div className="relative  text-gray-500 focus-within:text-gray-900 mb-4">
                ...
                id="default-search" className="block w-80 h-11 pr-5 pl-12 py-2.5 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none" placeholder="Search for company" />
            </div>
            <div className="overflow-hidden ">
                ...
                <thead>
                    ...
                    <th scope="col" className="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Member Since </th>
                ...
                <tbody className="divide-y divide-gray-300 ">
                    {paginatedData.map((u)=>(
                        <tr key={u.id} className="bg-sky-100 transition-all duration-500 hover:bg-sky-500">
                    <td className="px-2 py-1 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{u.userName}</td>
                    <td className="px-2 py-1 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {u.userPhoneNumber} </td>
                    <td className="px-2 py-1 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {u.userEmail}</td>
                    <td className="px-2 py-1 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {u.createdAt ? new Date(u.createdAt).toLocaleDateString() : "-"}</td>
...
//                                   d="M9.53414 8.15675L8.96459 7.59496L..."
//                                 />
//                               </svg>
//                             </button>
//                             <button className="p-2 rounded-full group transition-all duration-500 flex item-center">
