...
// import { fetchElectronics } from '@/lib/store/products/product-slice';

// function Electronics() {
//   const dispatch = useAppDispatch();
//   const products = useAppSelector((store) => store.product.electronics); // get product array
...
//         <h1 className="text-3xl font-semibold text-left">Electronics</h1>
//       </div>
...
function Electronics() {
  ...
  const products = useAppSelector((store) => store.product.categoryProducts['electronics'] ?? []);
